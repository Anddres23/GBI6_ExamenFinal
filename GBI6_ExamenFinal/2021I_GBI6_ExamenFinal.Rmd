...
descr(migroup) %>% tab_df(title = "Cancer y niveles de expresion de distintos genes",
                              file = "C:/Users/Dell/OneDrive/Documents/GBI6_ExamenFinal/results/mRNA_expr_summary.doc")
...
#puede que este este bien 
prue<- df %>% 
    group_by(dataset) %>% 
    summarise(expression_level =mean(GATA3:GAPDH))
